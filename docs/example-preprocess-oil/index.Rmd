...
This R Markdown document is part of a series of other examples like this one.  The purpose of these examples is to demonstrate how to solve problems in data science and analytics engineering with tools like R, Tableau, Linear Regression, Anomally Detection, etc.  

If you want to learn more about these examples, please checkout the [home page](https://andrew-j-leonard.github.io).

### Syntax Commonly Used in This Document
